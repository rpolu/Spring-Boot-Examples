...
<body>
	<form:form action="${pageContext.servletContext.contextPath}/saveUser" method="post" modelAttribute="userForm">
	
	<div class="container">
			<h1>Register</h1>
			<p>Please fill in this form to create an User.</p>
	 <label for="phno"><b>Ph No</b></label>
     <input type="text" placeholder="Enter phno" name="phno" id="phno" required>
